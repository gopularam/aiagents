...
def main():
    ...
    queries = [
        "Plan a trip to Mumbai: need flight AA123 status, hotel for next week, and local events",
        "Find the cheapes time to fly from Hyderabad to Mumbai next month and suggest a hotels",
    ]
