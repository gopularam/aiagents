...
print("== 6. structured_retriever(Who is Aurelian?)")

print(structured_retriever("Who is Aurelian?"))

print("== 7. structured_retriever(Who is Commudus?)")
...
print("== 9. structured_retriever(Who is Commudus?)")
